function [OUTPUT] = RWD_main_NoTTL(Params,stim,OptParams)
...
try 
    for rep = 1 : TotalTrial
        ...
        filename_temp = [path_save '/temp/' matfiles_n,'_RWD_TempSave'];
...
filename = [path_save '/' matfiles_n '_RWD_' filename_date];
