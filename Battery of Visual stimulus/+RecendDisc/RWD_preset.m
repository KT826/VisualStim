function [stim] = RWD_preset(Params,OptParams)
global monitor
global grid
%%
...
total_frame_expand =round(((Params.loom_initial_size-Params.loom_final_size)/Params.loom_velocity)/monitor.ifi); %period-expanding
...
sz_per_frame(1:total_frame_pause) = sz_per_frame_expand(1);
sz_per_frame(total_frame_pause+1:total_frame_expand+total_frame_pause) = sz_per_frame_expand;
%%% degree to pixel
