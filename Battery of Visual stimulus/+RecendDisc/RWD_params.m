function [Params,OptParams] = RWD_params(StimCenterPosi)
clear Params OptParams stim
global monitor
%% Recending disk
Params.type = 'RWD';
Params.rep = 8; %Repetition
Params.stim_color = monitor.color.white; %VS_info.stim_color = monitor.color.black; 
Params.loom_initial_size = 60; %deg
Params.loom_final_size = 2; %deg
